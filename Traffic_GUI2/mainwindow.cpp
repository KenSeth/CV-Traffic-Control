...
void MainWindow::on_selectInt_clicked()
{
    ...
    if (ui->radioTjunc->isChecked()) {
        ...
        ui->viewJunc4->hide(); //ui->info4->hide();
    ...
    //    if (checkStat == 1) {
            if(ifBox == 1){
                ...
                if(total_area_l1 < v1_area * LOW_PERCENT){
                    sprintf(buff,"V1 - SNR (Cebu): LOW (%.2f%)",(float)((float)total_area_l1/v1_area)*100);
                    ...
                    sprintf(buff,"V1 - SNR (Cebu): MOD (%.2f%)",(float)((float)total_area_l1/v1_area)*100);
                    ui->listWidget->item(0)->setText(QString(buff));
                    ...
                    sprintf(buff,"V1 - SNR (Cebu): HIGH (%.2f%)",(float)((float)total_area_l1/v1_area)*100);
                    ui->listWidget->item(0)->setText(QString(buff));
